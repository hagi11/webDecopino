...
<div class="card-body">
  <form method="POST" id="formProducto" action="{{ route('productos.update', $producto->id) }}">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="iva" type="text" class="form-control @error('iva') is-invalid @enderror" name="iva" value="{{ old('iva', $producto->iva) }}" required autocomplete="iva" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="descuento" type="text" class="form-control @error('descuento') is-invalid @enderror" name="descuento" value="{{ old('descuento', $producto->descuento) }}" required autocomplete="descuento" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="existencia" type="text" class="form-control @error('existencia') is-invalid @enderror" name="existencia" value="{{ old('existencia', $producto->existencia) }}" required autocomplete="existencia" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="estilo" type="text" class="form-control @error('estilo') is-invalid @enderror" name="estilo" value="{{ old('estilo', $producto->estilo) }}" required autocomplete="estilo" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="dimension" type="text" class="form-control @error('dimension') is-invalid @enderror" name="dimension" value="{{ old('dimension', $producto->dimension) }}" required autocomplete="dimension" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="peso" type="text" class="form-control @error('peso') is-invalid @enderror" name="peso" value="{{ old('peso', $producto->peso) }}" required autocomplete="peso" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="material" type="text" class="form-control @error('material') is-invalid @enderror" name="material" value="{{ old('material', $producto->material) }}" required autocomplete="material" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="tipopintura" type="text" class="form-control @error('tipopintura') is-invalid @enderror" name="tipopintura" value="{{ old('tipopintura', $producto->tipopintura) }}" required autocomplete="tipopintura" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="detalle" type="text" class="form-control @error('detalle') is-invalid @enderror" name="detalle" value="{{ old('detalle', $producto->detalle) }}" required autocomplete="detalle" autofocus>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="garantia" type="text" class="form-control @error('garantia') is-invalid @enderror" name="garantia" value="{{ old('garantia', $producto->garantia) }}" required autocomplete="garantia" autofocus>
